import { TARGETS } from '../text/glossary.js';
...
- applies_to — технологии, инструменты и ассистенты, к которым относится правило, только из словаря: ${TARGETS.join(', ')}. Только прямо названные во фразе. Файлы, пакеты, классы, папки кода в applies_to не пиши (им место в tags). Нет подходящих — [].
